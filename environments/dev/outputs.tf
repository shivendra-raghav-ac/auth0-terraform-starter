...
output "universal_login_experience" {
  description = "Configured Universal Login experience"
  value       = module.prompts.universal_login_experience
}

output "identifier_first_enabled" {
  description = "Whether identifier-first flow is enabled"
  value       = module.prompts.identifier_first
}

output "custom_text_languages" {
  description = "Languages with custom text configured"
  value       = module.prompts.custom_text_languages
}
